"""
LEGACY: Módulo para generar reportes en Excel de las mediciones de calidad del aire.
NOTA: Este archivo es legacy y será reemplazado por src/services/report_service.py
"""
...
def generate_excel_report(
    ...
    if period == 'hour':
        ...
        end_dt = now
        title = "Reporte Últimas 12 Horas - Minuto a Minuto"
    elif period == '24hours':
        # Últimas 24 horas
